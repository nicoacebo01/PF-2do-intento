...
const AppSettingsPanel: React.FC<AppSettingsPanelProps> = ({ settings, onUpdateSettings }) => {
    ...
    <div>
      ...
      <div className="space-y-8">
        ...
        <fieldset>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 mb-3">Define si los cálculos de tasas anualizadas (CFT) usan 360 o 365 días como base.</p>
