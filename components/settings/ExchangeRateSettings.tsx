...
const ExchangeRateSettings: React.FC<ExchangeRateSettingsProps> = ({ 
  ...
  const { exportData, exportColumns } = useMemo(() => {
    ...
    const columns: ExportColumn<any>[] = [
        ...
        { header: 'Spot', accessor: d => d.spotRate?.toLocaleString('es-AR', {minimumFractionDigits: 2}) || '' },
        ...sortedFutureDates.map(date => ({
            header: new Date(date + 'T00:00:00Z').toLocaleDateString('es-AR', { timeZone: 'UTC' }),
            accessor: (d: any) => d.futures[date]?.toLocaleString('es-AR', {minimumFractionDigits: 2}) || ''
        }))
    ];
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSaveAll} className="space-y-4 bg-gray-100 dark:bg-gray-800/50 p-6 rounded-lg mb-6">
      ...
      <div className="space-y-4 bg-gray-100 dark:bg-gray-800/50 p-6 rounded-lg mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
       ...
       <div className="mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end bg-gray-100 dark:bg-gray-800/50 p-4 rounded-lg">
                <div>
